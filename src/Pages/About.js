    ...
    <div className={classes.content}>
      <article>
        ...
        <div className={classes.link}>
          <a
            href="https://github.com/iamnickko/ecommerce-cart"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <Card className={classes.card}>
          ...
          <p>
            ...
            same <code>id</code> products into one item render and dynamically
            adjusts quantity, subtotal and total values. Quantity can adjusted
            in the cart and will remove products when quantity reaches 0. The
            component will not render when the cart is empty. is not empty
          </p>
          <p>
            The authentication is basic and used as a chance to implement a
            second redux slice.
          </p>
          <div className={classes.link}>
            <Link to="/cart">
